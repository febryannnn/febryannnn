...
## 📌 Pinned Projects
- 🤖 [Final-Project-Robotics-ITS-Robocon](https://github.com/febryannnn/Final-Project-Robotics-ITS-Robocon) – Robotics project for ITS Robocon competition.
- 📊 [Customer-Segmentation-with-KMeans-Algorithm](https://github.com/febryannnn/Customer-Segmentation-with-KMeans-Algorithm) – Customer segmentation using KMeans clustering in Jupyter Notebook.
- 🧠 [Machine-Learning](https://github.com/febryannnn/Machine-Learning) – Machine learning experiments and models built with Python.
- 🗺️ [AI-Route-Optimizer-with-Search-Algorithm](https://github.com/febryannnn/AI-Route-Optimizer-with-Search-Algorithm) – AI-powered route optimization using search algorithms in JavaScript.
- 🍽️ [frontend-tcanteen](https://github.com/febryannnn/frontend-tcanteen) – Frontend for a digital canteen application built with JavaScript.
- 🏠 [victoria-property-frontend](https://github.com/febryannnn/victoria-property-frontend) – Property listing frontend built with TypeScript.
